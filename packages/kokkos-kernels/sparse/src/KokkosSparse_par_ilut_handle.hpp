...
class PAR_ILUTHandle {
 ...
 public:
  ...
  PAR_ILUTThresholdSelectAlgorithm get_threshold_select_algorithm() const { return threshold_select_algorithm; }

  void set_threshold_select_algorithm(const PAR_ILUTThresholdSelectAlgorithm threshold_select_algorithm_) {
    this->threshold_select_algorithm = threshold_select_algorithm_;
    clear_cached_pattern();
  }

  int get_threshold_select_num_buckets() const { return threshold_select_num_buckets; }
